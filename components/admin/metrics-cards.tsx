        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              ...
              {metrics.revenueChange.toFixed(1)}% so với tháng trước
            </p>
          </CardContent>
        </Card>
      </Suspense>
      ...
      <Suspense fallback={<MetricCardSkeleton />}>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              +{metrics.newOrders} trong giờ qua
            </p>
          </CardContent>
        </Card>
      </Suspense>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              ...
              {metrics.customerChange.toFixed(1)}% so với tháng trước
            </p>
          </CardContent>
        </Card>
      </Suspense>
      ...
      <Suspense fallback={<MetricCardSkeleton />}>
        <Card>
          ...
          <CardContent>
            ...
            <p className='text-xs text-muted-foreground'>
              {metrics.aovChange > 0 ? '+' : ''}
              {metrics.aovChange.toFixed(1)}% so với tuần trước
            </p>
          </CardContent>
        </Card>
      </Suspense>
